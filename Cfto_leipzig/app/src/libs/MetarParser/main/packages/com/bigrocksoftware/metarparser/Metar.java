...
public class Metar {
    ...
    ArrayList<SkyCondition> skyConditions = new ArrayList<SkyCondition>();
     ...
     * 
     * @param value
     *            string that represents the date this METAR report was generated
     */
     ...
     * 
     * @param value
     *            the date this METAR report was generated
     */
     ...
     * 
     * @param value
     *            the modifier of the report, which specifies whether this report was an automated report or was a
     *            corrected report
     */
    ...
    /**
     * 
     * @return the modifier of the report, which specifies whether this report was an automated report or was a
     *         corrected report
     */
     ...
     * 
     * @param value
     *            the station id of the station that generated this METAR report
     */
     ...
     * 
     * @param value
     *            the direction the wind is blowing in (in degrees)
     */
     ...
     * 
     * @param value
     *            the minimum wind direction (in degrees) for variable wind directions
     */
    ...
    /**
     * 
     * @return the minimum wind direction (in degrees) for variable wind directions
     */
     ...
     * 
     * @param value
     *            the maximum wind direction (in degrees) for variable wind directions
     */
    ...
    /**
     * 
     * @return the maximum wind direction (in degrees) for variable wind directions
     */
     ...
     * 
     * @param value
     *            whether or not the wind direction is variable
     */
    ...
    /**
     * this function will also set visibility to 10KM, since CAVOK means visibility is greater than 10KM
     * 
     * @param value
     *            boolean whether or not CAVOK was given
     */
     ...
     * 
     * @param value
     *            precise temperature in celsius
     */
     ...
     * 
     * @param value
     *            whether or not the weather has changed significantly
     */
    ...
    /**
     * 
     * @return whether or not there has been a significant change in weather
     */
     ...
     * @see SkyCondition
     */
    public ArrayList<SkyCondition> getSkyConditions() {
    ...
    public void print() {
        ...
        System.out.println("temperaturePrecise: " + getTemperaturePreciseInCelsius() + " C, "
                + getTemperaturePreciseInFahrenheit() + " F");
        System.out.println("temperature: " + getTemperatureInCelsius() + " C, " + getTemperatureInFahrenheit() + " F");
        System.out.println("temperatureMostPrecise: " + getTemperatureMostPreciseInCelsius() + " C, "
                + getTemperatureMostPreciseInFahrenheit() + " F");

        System.out.println("dewPointPrecise: " + getDewPointPreciseInCelsius() + " C, "
                + getDewPointPreciseInFahrenheit() + " F");
        System.out.println("dewPoint: " + getDewPointInCelsius() + " C, " + getDewPointInFahrenheit() + " F");
        System.out.println("dewPointMostPrecise: " + getDewPointMostPreciseInCelsius() + " C, "
